...
import ConversationPractice from "@/components/ConversationPractice"; // ← NOUVEAU
...
type Tab = "home" | "dashboard" | "smartReview" | "listening" | "reading" | "flashcards" | 
           "conjugation" | "grammar" | "vocabQuiz" | "orthographe" | "dictee" | "badges" | "planning" | "conversations"; // ← AJOUTÉ
...
const tabs: { id: Tab; label: string; icon: string; color: string }[] = [
  ...
  { id: "conversations", label: "Conversations", icon: "💬", color: "#a78bfa" }, // ← NOUVEAU
  ...
  return (
    <main>
      ...
      <div style={{ minHeight: "400px" }}>
          ...
          <div className="vstack" style={{ gap: "16px" }}>
              ...
              <div style={{ marginTop: "16px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "12px", marginTop: "12px" }}>
                  ...
                  <button 
                    ...
                    className="card"
                    style={{ cursor: "pointer", background: "#4c1d95", border: "1px solid #a78bfa" }}
                  >
                    <div style={{ fontSize: "32px" }}>💬</div>
                    <strong>Conversations</strong>
                    <div className="muted" style={{ fontSize: "12px" }}>Dialogues interactifs</div>
                  </button>
                  <button 
            ...
            <div className="card" style={{ background: "#0b1220" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(120px, 1fr))", gap: "16px", textAlign: "center" }}>
                ...
                <div>
                  <div style={{ fontSize: "28px", fontWeight: "bold", color: "#a78bfa" }}>15+</div>
                  <div className="muted" style={{ fontSize: "12px" }}>Conversations</div>
                </div>
                <div>
        ...
        {activeTab === "conversations" && <ConversationPractice level={level} country={country} />} {/* ← NOUVEAU */}
      ...
      <div style={{ textAlign: "center", marginTop: "48px", padding: "16px", opacity: 0.5, fontSize: "12px" }}>
        Spanish Sprint v3.3 · Conversations interactives + 8 pays hispanophones 🚀
      </div>
    </main>
  );
                      }
