// src/data/words/catalan/A2.ts

export interface CatalanCardA2 {
  id: string;
  front: string;
  back: string;
  backEn?: string;
...
export const catalanWordsA2: CatalanCardA2[] = [
  ...
  { id: 'cat-a2-004', front: 'o',         back: 'ou',             backEn: 'or',            level: 'A2', country: 'catalonia', category: 'connector' },
  { id: 'cat-a2-005', front: 'si',        back: 'si',             backEn: 'if',            level: 'A2', country: 'catalonia', category: 'connector' },
  { id: 'cat-a2-006', front: 'quan',      back: 'quand',          backEn: 'when',          level: 'A2', country: 'catalonia', category: 'connector' },
  { id: 'cat-a2-007', front: 'també',     back: 'aussi',          backEn: 'also / too',    level: 'A2', country: 'catalonia', category: 'connector' },
  ...
  { id: 'cat-a2-014', front: 'llegir',    back: 'lire',                       backEn: 'to read',            level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-015', front: 'escriure',  back: 'écrire',                     backEn: 'to write',           level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-016', front: 'escoltar',  back: 'écouter',                    backEn: 'to listen',          level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-017', front: 'mirar',     back: 'regarder',                   backEn: 'to look / watch',    level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-018', front: 'trobar',    back: 'trouver',                    backEn: 'to find',            level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-019', front: 'ajudar',    back: 'aider',                      backEn: 'to help',            level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-020', front: 'recordar',  back: 'se rappeler',                backEn: 'to remember',        level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-021', front: 'oblidar',   back: 'oublier',                    backEn: 'to forget',          level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-022', front: 'esperar',   back: 'attendre / espérer',         backEn: 'to wait / hope',     level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-023', front: 'preguntar', back: 'poser une question',         backEn: 'to ask',             level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-024', front: 'contestar', back: 'répondre',                   backEn: 'to answer',          level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-025', front: 'entendre',  back: 'comprendre',                 backEn: 'to understand',      level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-026', front: 'portar',    back: 'porter / apporter',          backEn: 'to bring / carry',   level: 'A2', country: 'catalonia', category: 'verb' },
  { id: 'cat-a2-027', front: 'deixar',    back: 'laisser / prêter',           backEn: 'to leave / lend',    level: 'A2', country: 'catalonia', category: 'verb' },
  ...
  { id: 'cat-a2-034', front: 'important',             back: 'important(e)',         backEn: 'important',   level: 'A2', country: 'catalonia', category: 'adjectiu' },
  { id: 'cat-a2-035', front: 'simpàtic / simpàtica',  back: 'sympa / sympathique',  backEn: 'friendly',   level: 'A2', country: 'catalonia', category: 'adjectiu' },
  { id: 'cat-a2-036', front: 'content / contenta',    back: 'content(e)',           backEn: 'happy',       level: 'A2', country: 'catalonia', category: 'adjectiu' },
  { id: 'cat-a2-037', front: 'cansat / cansada',      back: 'fatigué(e)',           backEn: 'tired',       level: 'A2', country: 'catalonia', category: 'adjectiu' },
  { id: 'cat-a2-038', front: 'trist / trista',        back: 'triste',               backEn: 'sad',         level: 'A2', country: 'catalonia', category: 'adjectiu' },
  { id: 'cat-a2-039', front: 'enfadat / enfadada',    back: 'fâché(e) / en colère', backEn: 'angry',       level: 'A2', country: 'catalonia', category: 'adjectiu' },
  { id: 'cat-a2-040', front: 'malalt / malalta',      back: 'malade',               backEn: 'sick / ill',  level: 'A2', country: 'catalonia', category: 'adjectiu' },
...
{ id: 'cat-a2-043', front: 'gener',    back: 'janvier',   backEn: 'January',   level: 'A2', country: 'catalonia', category: 'mes' },
  ...
  { id: 'cat-a2-047', front: 'maig',     back: 'mai',       backEn: 'May',       level: 'A2', country: 'catalonia', category: 'mes' },
  { id: 'cat-a2-048', front: 'juny',     back: 'juin',      backEn: 'June',      level: 'A2', country: 'catalonia', category: 'mes' },
  { id: 'cat-a2-049', front: 'juliol',   back: 'juillet',   backEn: 'July',      level: 'A2', country: 'catalonia', category: 'mes' },
  { id: 'cat-a2-050', front: 'agost',    back: 'août',      backEn: 'August',    level: 'A2', country: 'catalonia', category: 'mes' },
  { id: 'cat-a2-051', front: 'setembre', back: 'septembre', backEn: 'September', level: 'A2', country: 'catalonia', category: 'mes' },
  ...
  { id: 'cat-a2-058', front: 'fa vent',      back: 'il y a du vent',     backEn: "it's windy",   level: 'A2', country: 'catalonia', category: 'meteorologia' },
  ...
  { id: 'cat-a2-070', front: 'el taxi',       back: 'le taxi',              backEn: 'taxi',              level: 'A2', country: 'catalonia', category: 'transport' },
  { id: 'cat-a2-071', front: 'la bicicleta',  back: 'le vélo',              backEn: 'bicycle',           level: 'A2', country: 'catalonia', category: 'transport' },
